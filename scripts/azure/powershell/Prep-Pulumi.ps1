...
$pulumiPassPhraseGenerator = $(-join (((48..57) + (65..90) + (97..122)) * 80 | Get-Random -Count 25 | ForEach-Object { [char]$_ }))
$spokePulumiPassphrase = ConvertTo-SecureString "$pulumiPassPhraseGenerator" -AsPlainText -Force
...
Set-AzKeyVaultSecret `
   ...
   -SecretValue $spokePulumiPassphrase
